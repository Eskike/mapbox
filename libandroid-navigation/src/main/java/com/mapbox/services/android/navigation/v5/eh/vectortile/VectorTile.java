...
package com.mapbox.services.android.navigation.v5.eh.vectortile;
...
public final class VectorTile {
  ...
  bitField0_ |= 0x00000001;
      ...
      protected final Object dynamicMethod(
        ...
        switch (method) {
          ...
          case GET_PARSER: {
            com.google.protobuf.Parser<VectorTile.Tile.Value> parser = PARSER;
            if (parser == null) {
    ...
    public  static final class Feature extends
      ...
      protected final Object dynamicMethod(
        ...
        switch (method) {
              ...
              while (!done) {
                ...
                switch (tag) {
                  ...
                  case 24: {
                    ...
                    VectorTile.Tile.GeomType value = VectorTile.Tile.GeomType.forNumber(rawValue);
                    if (value == null) {
          ...
          case GET_PARSER: {
            com.google.protobuf.Parser<VectorTile.Tile.Feature> parser = PARSER;
            if (parser == null) {
  ...
  bitField0_ |= 0x00000002;
      ...
      private void addAllFeatures(
          Iterable<? extends VectorTile.Tile.Feature> values) {
        ensureFeaturesIsMutable();
        com.google.protobuf.AbstractMessageLite.addAll(
            values, features_);
      }
  ...
  ensureKeysIsMutable();
      ...
      private void addAllValues(
          Iterable<? extends VectorTile.Tile.Value> values) {
        ensureValuesIsMutable();
        com.google.protobuf.AbstractMessageLite.addAll(
            values, values_);
      }
      ...
      protected final Object dynamicMethod(
        ...
        switch (method) {
          ...
          case GET_PARSER: {
            com.google.protobuf.Parser<VectorTile.Tile.Layer> parser = PARSER;
            if (parser == null) {
    ...
    private void addAllLayers(
        Iterable<? extends VectorTile.Tile.Layer> values) {
      ensureLayersIsMutable();
      com.google.protobuf.AbstractMessageLite.addAll(
          values, layers_);
    }
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<VectorTile.Tile> parser = PARSER;
          if (parser == null) {
